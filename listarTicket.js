...
document.getElementById("lastlogin").innerHTML = "<table><tr><td>Cliente</td><td>"+query.id+"</td></tr><tr><td>Contacto</td><td>"+query.contacto+"</td></tr><tr><td>Nombre</td><td>"+query.nombre+"</td></tr><tr><td>Ultimo ingreso</td><td>"+query.ultimo+"</td></tr></table>";
...
const APIREST_URL='https://x7vzzhl0o0.execute-api.us-east-1.amazonaws.com/listarTicketGet?clienteID='+query.id;
console.log ("ID es:"+query.contacto+"   APIREST_URl:" +APIREST_URL);
